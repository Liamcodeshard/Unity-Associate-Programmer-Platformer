...
public class RefactorEnemy : MonoBehaviour
{
    ...
    private PatrolEnemy patrolBehavior;
    public Transform sightDebugger;
    ...
    private void Start()
    {
        ...
        patrolBehavior = GetComponent<PatrolEnemy>();
    ...
    {
        //Chase the player
        sightDebugger.position = new Vector3(player.transform.position.x, transform.position.y, player.transform.position.z);
